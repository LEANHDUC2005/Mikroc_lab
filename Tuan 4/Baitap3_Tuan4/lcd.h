...
/* Cac khai bao ket noi chan LCD voi PIC */
        #define        LCD_RS                RB4_bit
        #define        LCD_EN                RB5_bit
        //#define        LCD_RW                RD2
        #define        LCD_DATA4        RB0_bit
        #define        LCD_DATA5        RB1_bit
        #define        LCD_DATA6        RB2_bit
        #define        LCD_DATA7        RB3_bit
        
        #define        LCD_RS_TRIS                TRISB4_bit
        #define        LCD_EN_TRIS                TRISB5_bit
        //#define        LCD_RW_TRIS                TRISD2
        #define        LCD_DATA4_TRIS        TRISB0_bit
        #define        LCD_DATA5_TRIS        TRISB1_bit
        #define        LCD_DATA6_TRIS        TRISB2_bit
        #define        LCD_DATA7_TRIS        TRISB3_bit
